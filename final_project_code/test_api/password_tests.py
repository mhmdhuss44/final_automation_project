...
class passwordTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.password_logic = passwordLogic(self.my_api)


    # test to make sure that the status is 200 for getting a strong password
    ...
    # test to check the generated password if it contains all of the condition
