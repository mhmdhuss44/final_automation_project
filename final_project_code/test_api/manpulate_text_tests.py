...
class textTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.text_logic = textManpulate(self.my_api)

    # test to make sure that the status is 200 for modifying text
    ...
    # test to a text and change every occurance of word1 to word2
